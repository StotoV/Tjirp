...
BEGIN
	...
	SET NOCOUNT ON
	BEGIN TRY
	IF NOT EXISTS (SELECT 1 FROM Article_in_Unit AiU
					INNER JOIN Inserted I
					ON AiU.Article_articleNo = I.Article_articleNo 
					AND AiU.Unit_name = I.Unit_name
					WHERE (AiU.Article_articleNo = I.Article_articleNo
					AND AiU.Unit_name = I.Unit_name))
		BEGIN
